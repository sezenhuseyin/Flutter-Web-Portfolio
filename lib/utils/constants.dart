...
class AppConstants {
  ...
  static const smartStoreImage = _projectsImages + "1.jpg";
  static const crossTheRoadImage = _projectsImages + "2.jpg";
  static const newsUpImage = _projectsImages + "3.jpg";
  static const musicLabImage = _projectsImages + "4.jpg";
  static const personalFaceImage = _projectsImages + "5.jpg";
